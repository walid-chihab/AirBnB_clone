...
Unittest classes:
    TestHBNBCommand_prompting_
    TestHBNBCommand_help_
    TestHBNBCommand_exit_
    TestHBNBCommand_create_
    TestHBNBCommand_show_
    TestHBNBCommand_all_
    TestHBNBCommand_destroy_
    TestHBNBCommand_update_
"""
import os
import sys
import unittest
...
class TestHBNBCommand_prompting_(unittest.TestCase):
...
class TestHBNBCommand_help_(unittest.TestCase):
    """Unittests for testing help messages of the HBNB command interpreter."""

    def test_help_quit_(self):
...
class TestHBNBCommand_exit_(unittest.TestCase):
    ...
    def test_quit_exits_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertTrue(HBNBCommand().onecmd("quit"))

    def test_EOF_exits_(self):
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_create_(unittest.TestCase):
    ...
    def test_create_missing_class_(self):
        correct = "** class name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create"))
            self.assertEqual(correct, output.getvalue().strip())

    def test_create_invalid_class_(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create MyModel"))
            self.assertEqual(correct, output.getvalue().strip())

    def test_create_invalid_syntax_(self):
...
class TestHBNBCommand_show_(unittest.TestCase):
    ...
    def test_show_missing_class_(self):
        correct = "** class name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_invalid_class_(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_missing_id_space_notation_(self):
    ...
    def test_show_missing_id_dot_notation_(self):
        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_no_instance_found_space_notation_(self):
    ...
    def test_show_no_instance_found_dot_notation_(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_destroy_(unittest.TestCase):
    ...
    def test_destroy_missing_class_(self):
        correct = "** class name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_invalid_class_(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_id_missing_space_notation_(self):
        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_invalid_id_space_notation_(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_invalid_id_dot_notation_(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_objects_space_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_objects_dot_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_all_(unittest.TestCase):
    ...
    def test_all_invalid_class_(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_all_objects_space_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
    ...
    def test_all_objects_dot_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
    ...
    def test_all_single_object_space_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
    ...
    def test_all_single_object_dot_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
...
class TestHBNBCommand_update_(unittest.TestCase):
    ...
    def test_update_invalid_class_(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_missing_id_space_notation_(self):
        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_missing_id_dot_notation_(self):
        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_invalid_id_space_notation_(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_invalid_id_dot_notation_(self):
        correct = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_missing_attr_name_space_notation_(self):
    ...
    def test_update_missing_attr_name_dot_notation_(self):
        correct = "** attribute name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testId = output.getvalue().strip()
    ...
    def test_update_missing_attr_value_space_notation_(self):
    ...
    def test_update_missing_attr_value_dot_notation_(self):
        correct = "** value missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
    ...
    def test_update_valid_string_attr_space_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
    ...
    def test_update_valid_string_attr_dot_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
    ...
    def test_update_valid_int_attr_space_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
    ...
    def test_update_valid_int_attr_dot_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
    ...
    def test_update_valid_float_attr_space_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
    ...
    def test_update_valid_float_attr_dot_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
    ...
    def test_update_valid_dictionary_space_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
        testCmd = "update BaseModel {} ".format(testId)
    ...
    def test_update_valid_dictionary_dot_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
        testCmd = "BaseModel.update({}".format(testId)
    ...
    def test_update_valid_dictionary_with_int_space_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "update Place {} ".format(testId)
    ...
    def test_update_valid_dictionary_with_int_dot_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "Place.update({}, ".format(testId)
    ...
    def test_update_valid_dictionary_with_float_space_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "update Place {} ".format(testId)
    ...
    def test_update_valid_dictionary_with_float_dot_notation_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "Place.update({}, ".format(testId)
...
class TestHBNBCommand_count_(unittest.TestCase):
    ...
    def test_count_invalid_class_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("MyModel.count()"))
            self.assertEqual("0", output.getvalue().strip())

    def test_count_object_(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
        with patch("sys.stdout", new=StringIO()) as output:
